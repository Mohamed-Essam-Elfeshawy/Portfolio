...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="py-24 relative bg-[#07090e]">
      ...
      <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-violet-600/10 rounded-full blur-[140px] pointer-events-none" />
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-300 ${
                    isActive
                      ...
                      : 'bg-[#121624] text-gray-400 hover:text-white border border-white/5 hover:border-cyan-500/30'
                  }`}
                >
                  {cat}
                </button>
              ...
              >
                ...
                <div className="relative h-52 sm:h-56 w-full bg-[#111625] overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 flex flex-wrap gap-1.5 z-10">
                    <span className="px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 backdrop-blur-md">
                      {project.category}
                    </span>
                    {project.featured && (
                      <span className="px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-amber-500/20 text-amber-300 border border-amber-500/30 backdrop-blur-md flex items-center gap-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {project.liveUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-white bg-gradient-to-r from-cyan-500 to-indigo-600 hover:from-cyan-400 hover:to-indigo-500 shadow-sm shadow-cyan-500/20 transition-all hover:scale-105"
                          >
                            <span>Live</span>
