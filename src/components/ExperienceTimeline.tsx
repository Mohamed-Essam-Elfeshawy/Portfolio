        ...
        <div className="relative pl-6 sm:pl-8 border-l-2 border-cyan-500/20 space-y-12">
          {filteredItems.map((item, idx) => (
            <div key={idx} className="relative group">
              ...
              <div className="glass-panel glass-panel-hover rounded-2xl p-6 sm:p-8 ml-2 relative">
                ...
                <div className="pt-4 border-t border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex flex-wrap gap-2">
                    {item.skills.map((skill) => (
                      <span
                        key={skill}
                        className="px-2.5 py-1 rounded-md bg-white/5 text-[11px] font-mono text-gray-400 border border-white/5 hover:text-cyan-300 hover:border-cyan-500/20 transition-colors"
                      >
                        {skill}
                      </span>
                    ))}
                  ...
                  {item.credentialUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-semibold text-cyan-300 bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 transition-all hover:scale-105 shrink-0 self-start sm:self-auto"
                    >
